<template>
  <div class="container">
    ...
    <h1>Count {{ count }}, isEven {{ evenOrOdd }}</h1>
    ...
    <div class="github-container">
        Wanna look into github profile:
        <input v-focus class="zip" v-model="gitUser"/>
        <div v-show="fetching">
...
export default {
  ...
  watch: {
    gitUser: _.debounce(function () {
      if (this.username) {
        this.fetching = 'fetching....'
        axios.get(`https://api.github.com/users/${this.gitUser}`)
          .then(response => {
